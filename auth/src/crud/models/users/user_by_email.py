...
class UserByEmail(Model):
    ...
    __cassandra_syncer_create_SASI_index_on__ = ["email"]

    org_identifier  = columns.Text(required=True, partition_key=True, min_length=6, max_length=255)
    email           = columns.Text(required=True, primary_key=True, custom_index=True, min_length=3, max_length=255) # https://stackoverflow.com/a/1423203 https://stackoverflow.com/a/574698
